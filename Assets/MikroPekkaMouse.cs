...
{
    [AddComponentMenu("Event/MikroPekkaMouse")]
    public class MikroPekkaMouse : PointerInputModule
    {
        ...
        [SerializeField]
        private RectTransform MikroPekkaCursor;
        [SerializeField]
        ...
        public override void UpdateModule()
        {
            ...
            m_MousePosition = MikroPekkaCursor.anchoredPosition;
        }
        ...
        public override void ActivateModule()
        {
            base.ActivateModule();
            m_MousePosition = MikroPekkaCursor.anchoredPosition;
            m_LastMousePosition = MikroPekkaCursor.anchoredPosition;
        ...
        private void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                pointerEvent.position = MikroPekkaCursor.anchoredPosition;
        ...
        protected override MouseState GetMousePointerEventData()
        {
            ...
            var screenSpaceCursorPosition = RectTransformUtility.WorldToScreenPoint(CanvasCamera, MikroPekkaCursor.position);
